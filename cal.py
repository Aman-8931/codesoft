...
if __name__ == "__main__":
	...
	button2 = Button(gui, text=' 2 ', fg='pink', bg='black',
	...
	button4 = Button(gui, text=' 4 ', fg='pink', bg='black',
	...
	button6 = Button(gui, text=' 6 ', fg='pink', bg='black',
	...
	button8 = Button(gui, text=' 8 ', fg='pink', bg='black',
	...
	plus = Button(gui, text=' + ', fg='pink', bg='black',
				command=lambda: press("+"), height=2, width=7)
	plus.grid(row=2, column=3)

	minus = Button(gui, text=' - ', fg='pink', bg='black',
				command=lambda: press("-"), height=2, width=7)
	minus.grid(row=3, column=3)

	multiply = Button(gui, text=' * ', fg='pink', bg='black',
					command=lambda: press("*"), height=2, width=7)
	multiply.grid(row=4, column=3)

	divide = Button(gui, text=' / ', fg='pink', bg='black',
					command=lambda: press("/"), height=2, width=7)
	divide.grid(row=5, column=3)

	equal = Button(gui, text=' = ', fg='pink', bg='black',
				command=equalpress, height=2, width=7)
	equal.grid(row=5, column=2)

	clear = Button(gui, text='Clear', fg='pink', bg='red',
				command=clear, height=2, width=7)
	clear.grid(row=5, column='1')

	Decimal= Button(gui, text='.', fg='pink', bg='black',
					command=lambda: press('.'), height=2, width=7)
